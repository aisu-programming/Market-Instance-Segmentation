...
from coco_dataloader import getDataset
    ...
    def demo(self):
        ...
        for i in range(2):
            for j in range(4):
                ...
                axs[i][j].set_title(f"Ans: {statuses[i*4+j]} | " + \
                    f"Pred: {[ f'{p:.3f}' for p in prediction[i*4+j]]}")
        plt.tight_layout()
...
if __name__ == "__main__":
    ...
    dataParameter = {
        "data_dir"    : "dataset/204-196_test_unannotated_splitted-1-9",
